...
class EvergladesGame:
    ...
    def game_init(self, player_dat):
        ...
        for player in players:
            ...
            for i, gid in enumerate(player_dat[player]['unit_config']):
                ...
                # if player == 1: #HACK: the unreal is expecting 0-24 not 0-11 and 0-11
                #     gid = gid + 12
        ...
        for player in self.team_starts:
            ...
            for gid, nid in action.astype(int):
                ...
                if test1 and test2 and test3:
                    ...
                    #Hack: adjustedID
                    adjustedGroupId = self.players[player].groups[gid].groupID + 1; # off by 1
    ...
    def movement(self):
        ...
        for player in self.team_starts:
            for group in self.players[player].groups:
                #Hack: adjustedID
                adjustedGroupId = group.mapGroupID;
    ...
    def SendFilesReadyMsg(self, sock):
        ...
        while True:
            ...
            try:
                # Tell the client the files are ready
                connection.sendall("Files Ready".encode('utf-8'))
                return
