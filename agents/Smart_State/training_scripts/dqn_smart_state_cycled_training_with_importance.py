...
players[0] = DQNAgent(
    ...
    map_name=map_name,
    train=TRAIN,
    network_save_name='/agents/Smart_State/saved_models/newton_cycled',
...
k = 100
p = 5000
stats = AgentStatistics(names[0], n_episodes, k, save_file=os.getcwd() + '/saved-stats/newton_cycled')
