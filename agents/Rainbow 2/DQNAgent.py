...
from agents.Rainbow2.agent_attributes.Network import Network
from agents.Rainbow2.agent_attributes.ReplayMemory import NStepModule
...
TARGET_UPDATE = 100 # The amount of samples before resetting target network
