...
class constants():
    def __init__(self, constants_path):
        ...
        self.v_min = constants['hyperparameters']['v_min']
        self.v_max = constants['hyperparameters']['v_max']
        self.atom_size = constants['hyperparameters']['atom_size']
        self.beta = constants['hyperparameters']['beta']
        self.prior_eps = constants['hyperparameters']['prior_eps']
