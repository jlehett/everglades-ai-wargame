...
from agents.A2C_Modified.A2C_Modified import A2C_Modified
...
# Setup agents  #
#################
players[0] = A2C_Modified(132, env.observation_space, 528, K_epochs)
names[0] = "DQN Agent"
...
for i_episode in range(1, n_episodes+1):
    ...
    lossValsActor.append(current_actor_loss)
    lossValsCritic.append(current_critc_loss)
    ...
    #################################
    print('\rEpisode: {}\tCurrent WR: {:.2f}\tWins: {}\tLosses: {} Ties: {} Eps/Temp: {:.2f} Actor Loss: {:.2f} Critic Loss: {:.2f} Average Reward: {:.2f}\n'.format(i_episode,current_wr,score,losses,ties,current_eps, current_actor_loss,current_critic_loss,average_reward), end="")
    if i_episode % k == 0:
