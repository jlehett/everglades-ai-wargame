...
from utils.Agent_Loader.agent_loader import AgentLoader
...
AgentLoader = AgentLoader(map_name)

#################
# Setup agents  #
#################
PLAYER_0_AGENT_SAVE_FILE = 'A2C_test_delayed'
PLAYER_0_AGENT = AgentLoader.loadAgent(
    save_file_path='saved-agents/' + PLAYER_0_AGENT_SAVE_FILE,
    player_num=0
)
players[0] = PLAYER_0_AGENT
names[0] = "A2C Agent"
players[1] = random_actions(env.num_actions_per_turn, 1, map_name)
names[1] = 'Random Actions'
#################
