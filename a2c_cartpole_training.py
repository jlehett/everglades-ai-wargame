...
from agents.A2C_Cartpole.A2C_Cartpole import A2C_Cartpole
...
# Setup agents  #
#################
players[0] = A2C_Cartpole(2, env.observation_space, 256, K_epochs)
names[0] = "A2C CartPole Agent"
#players[1] = random_actions(num_actions, 1, map_name)
...
for i_episode in range(1, n_episodes+1):
    ...
    while not done:
        ...
        #for pid in players:
        actions[0] = players[0].get_action( observations )
